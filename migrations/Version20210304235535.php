 ...
 */
final class Version20210304235535 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE review (id INT AUTO_INCREMENT NOT NULL, description LONGTEXT NOT NULL, user_id INT NOT NULL, listing_id INT NOT NULL, rate INT NOT NULL, date DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
